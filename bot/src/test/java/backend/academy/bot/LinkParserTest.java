...
class LinkParserTest {
    ...
    private static Stream<Arguments> provideTestCases() {
        return Stream.of(
                Arguments.of("https://github.com/user/repo", LinkType.GITHUB_REPO, false),
                Arguments.of("https://github.com/user/repo/issues/123", LinkType.GITHUB_ISSUE, false),
                Arguments.of("https://github.com/user/repo/pull/4", LinkType.GITHUB_PR, false),
                Arguments.of("https://stackoverflow.com/questions/123", LinkType.STACKOVERFLOW, false),
